...
public class GreaterThanFilter implements ConditionFilter {
	...
	public GreaterThanFilter(Object reference, ArrayList<String> allColumns, ArrayList<String> columns, String column) {
